...
export const pressureConverterL10n: ToolL10n = {
  ...
  es: {
    ui: {
      ...
      'unit.bar': 'Bares (bar)',
      'unit.inhg': 'Pulgadas de mercurio (inHg)',
      'unit.kgfcm2': 'Kilogramo-fuerza/cm² (kgf/cm²)',
  ...
  de: {
    ui: {
      ...
      'unit.bar': 'Bar (bar)',
      'unit.inhg': 'Zoll Quecksilbersäule (inHg)',
      'unit.kgfcm2': 'Kilopond/cm² (kgf/cm²)',
