...
export const qrCodeGeneratorL10n: ToolL10n = {
  zh: {
    ui: {
      ...
      'encWpa': 'WPA / WPA2',
      'encryption': '加密方式',
      'errorTooLong': '内容对二维码来说太长(最多约 2000 字符)。请用更短的 URL 或文本模式输入。',
      'foreground': '前景色',
  ...
  es: {
    ui: {
      ...
      'encWpa': 'WPA / WPA2',
      'encryption': 'Cifrado',
      'errorTooLong': 'El contenido es demasiado largo para un código QR (máx. ~2000 caracteres). Usa el modo URL o texto con una entrada más corta.',
  ...
  de: {
    ui: {
      ...
      'errorTooLong': 'Der Inhalt ist zu lang für einen QR-Code (max. ~2000 Zeichen). URL- oder Textmodus mit kürzerer Eingabe verwenden.',
