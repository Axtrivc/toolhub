...
export const TakeHomePayCalculatorL10n: ToolL10n = {
  zh: {
    ...
    ui: {
      'chartTitle': '你的工资去哪了',
      'slice.annualNet': '到手工资',
      'slice.fedTax': '联邦所得税',
      'slice.fica': '社保与医保 (FICA)',
      'chartCenter': '税前总额',
      'in.annualNet': '预计年度税后',
      'in.fedTax': '联邦所得税估算',
      'in.fica': 'FICA(社保+医保)',
  ...
  es: {
    ...
    ui: {
      'chartTitle': 'A dónde va tu salario',
      'slice.annualNet': 'Salario neto',
      'slice.fedTax': 'Impuesto federal',
      'slice.fica': 'FICA (SS + Medicare)',
      'chartCenter': 'Bruto',
  ...
  de: {
    ...
    ui: {
      'chartTitle': 'Wohin Ihr Gehalt geht',
      'slice.annualNet': 'Nettolohn',
      'slice.fedTax': 'Bundeseinkommensteuer',
      'slice.fica': 'Sozial- und Medicare-Abgaben',
      'chartCenter': 'Brutto',
