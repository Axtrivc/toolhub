...
export const cronParserL10n: ToolL10n = {
  zh: {
    ui: {
      ...
      'atReboot': '启动时执行(@reboot)——调度器启动时运行一次,无重复周期',
      'atSecond': '在第 {secs} 秒, ',
  ...
  es: {
    ui: {
      ...
      'atReboot': 'Al arrancar (@reboot) — se ejecuta una vez cuando arranca el planificador, sin programación repetitiva',
      'atSecond': 'en el segundo {secs}, ',
  ...
  de: {
    ui: {
      ...
      'atReboot': 'Beim Start (@reboot) — läuft einmal beim Start des Schedulers, ohne wiederkehrenden Zeitplan',
      'atSecond': 'in Sekunde {secs}, ',
