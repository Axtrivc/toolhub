...
export const faviconGeneratorL10n: ToolL10n = {
  zh: {
    ui: {
      ...
      'downloadIco': '下载 favicon.ico',
      'downloadPng': '下载 PNG',
      'errCouldNotRead': '无法读取文件。',
      'errIcoBuild': '生成 favicon.ico 失败(PNG 编码出错)。',
      'errUploadImage': '请上传图片文件(PNG、JPG、GIF 或 WebP)。',
      'htmlSnippetHint': '把下载的文件重命名为对应名称(或修改路径),放在站点根目录。',
      'htmlSnippetLabel': 'HTML 片段——粘贴到 <head> 内',
  ...
  es: {
    ui: {
      ...
      'errIcoBuild': 'No se pudo crear favicon.ico (falló la codificación PNG).',
      'errUploadImage': 'Sube una imagen (PNG, JPG, GIF o WebP).',
      'htmlSnippetHint': 'Renombra los archivos descargados para que coincidan (o edita las rutas) y colócalos en la raíz del sitio.',
      'htmlSnippetLabel': 'Fragmento HTML — pégalo en tu <head>',
  ...
  de: {
    ui: {
      ...
      'errIcoBuild': 'favicon.ico konnte nicht erstellt werden (PNG-Codierung fehlgeschlagen).',
      'errUploadImage': 'Bitte eine Bilddatei hochladen (PNG, JPG, GIF oder WebP).',
      'htmlSnippetHint': 'Benenne die heruntergeladenen Dateien entsprechend um (oder passe die Pfade an) und lege sie ins Stammverzeichnis deiner Website.',
      'htmlSnippetLabel': 'HTML-Snippet — in deinen <head> einfügen',
