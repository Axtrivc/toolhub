...
export const roiCalculatorL10n: ToolL10n = {
  ...
  es: {
    ...
    ui: {
      'chartTitle': 'Inicial vs final',
      'cmp.0': 'Valor final',
      'cmp.1': 'Pérdida',
      'cmpseg.0': 'Inversión inicial',
      'cmpseg.1': 'Beneficio',
      'cmpseg.2': 'Valor final',
  ...
  de: {
    ...
    ui: {
      'chartTitle': 'Anfangs- vs. Endwert',
      'cmp.0': 'Endwert',
      'cmp.1': 'Verlust',
      'cmpseg.0': 'Anfangsinvestition',
      'cmpseg.1': 'Gewinn',
      'cmpseg.2': 'Endwert',
