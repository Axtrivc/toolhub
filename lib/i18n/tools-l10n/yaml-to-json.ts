...
export const yamlToJsonL10n: ToolL10n = {
  zh: {
    ui: {
      ...
      'invalidYaml': '无效 YAML',
      'multiDocWarning': '检测到多个 YAML 文档(---)。仅转换第一个文档。',
  ...
  es: {
    ui: {
      ...
      'multiDocWarning': 'Se detectaron varios documentos YAML (---). Solo se convirtió el primero.',
  ...
  de: {
    ui: {
      ...
      'multiDocWarning': 'Mehrere YAML-Dokumente erkannt (---). Nur das erste Dokument wurde konvertiert.',
