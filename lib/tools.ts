...
export const tools: ToolMeta[] = [
  ...
  // ─────────── 🤖 AI & Modern Dev Tools (batch 12) ───────────
  {
    ...
    intent: 'informational', category: 'AI Tools', h1: 'GPT Token Counter',
  ...
  {
    slug: 'hysa-calculator', name: 'HYSA Calculator',
    title: 'HYSA Calculator - High-Yield Savings Growth & Interest',
    description: 'Project your high-yield savings account (HYSA) balance with daily compounding and monthly deposits. See interest earned and growth over time. Free, no signup.',
    keywords: ['hysa calculator', 'high yield savings calculator', 'savings account interest calculator', 'high interest savings projection', 'apy savings calculator'],
    intent: 'commercial', category: 'Finance Calculators', h1: 'High-Yield Savings (HYSA) Calculator',
    shortIntro: 'Project HYSA growth with daily compounding and monthly deposits.', published: true,
    longTailKeywords: [
      'high yield savings calculator with monthly deposits',
      'hysa compound interest projection daily',
      'how much interest on savings per month',
      '4.5 apy savings growth calculator',
    ],
    titleLongTail: 'HYSA Calculator - Daily Compounding & Monthly Deposits',
    descriptionLongTail: 'Enter your deposit, monthly contribution, and APY to see your high-yield savings balance, interest earned, and growth curve. Free, instant, no signup.',
    nextTools: ['cd-calculator', 'compound-interest-calculator'],
  },
  {
    slug: 'cd-calculator', name: 'CD Calculator',
    title: 'CD Calculator - Maturity Value & Early Withdrawal Penalty',
    description: 'Calculate Certificate of Deposit maturity value with daily, monthly, or quarterly compounding — plus an early-withdrawal penalty simulation. Free, no signup.',
    keywords: ['cd calculator', 'certificate of deposit calculator', 'cd interest calculator', 'cd maturity calculator', 'cd early withdrawal penalty'],
    intent: 'commercial', category: 'Finance Calculators', h1: 'CD Calculator (Certificate of Deposit)',
    shortIntro: 'CD maturity value plus early-withdrawal penalty simulation.', published: true,
    longTailKeywords: [
      'certificate of deposit maturity value calculator',
      'cd early withdrawal penalty calculator',
      'how much will my cd be worth',
      'cd ladder calculator monthly interest',
    ],
    titleLongTail: 'CD Calculator - Maturity Value & Penalty Simulator',
    descriptionLongTail: 'See what your CD pays at maturity with daily compounding, and exactly what breaking it early costs after the penalty. Compare hold vs exit. Free.',
    nextTools: ['hysa-calculator', 'compound-interest-calculator'],
  },
  {
    slug: 'roth-ira-calculator', name: 'Roth IRA Calculator',
    title: 'Roth vs Traditional IRA Calculator - Which Saves More Tax?',
    description: 'Compare Roth vs Traditional IRA side by side: enter your age, tax rate today, and expected retirement tax rate to see which account leaves more after-tax money.',
    keywords: ['roth ira calculator', 'roth vs traditional ira', 'roth ira contribution limit', 'ira tax savings calculator', 'should i choose roth or traditional'],
    intent: 'commercial', category: 'Finance Calculators', h1: 'Roth vs Traditional IRA Calculator',
    shortIntro: 'Roth vs Traditional IRA, side by side — same dollars, different tax paths.', published: true,
    longTailKeywords: [
      'roth or traditional ira in 24 percent bracket',
      'roth vs traditional at retirement tax rate',
      '7000 dollar ira contribution tax savings',
      'roth ira break even tax rate',
    ],
    titleLongTail: 'Roth vs Traditional IRA - Same $7,000, Different Tax Paths',
    descriptionLongTail: 'Enter your age, bracket today, and expected bracket in retirement: watch both accounts grow to the day you withdraw and see which hands you more after tax.',
    nextTools: ['retirement-calculator', 'compound-interest-calculator'],
  },
  {
    slug: 'fire-calculator', name: 'FIRE Calculator',
    title: 'FIRE Calculator - Your FIRE Number & Early Retirement Date',
    description: 'Calculate your FIRE number from annual spending, savings, and safe withdrawal rate. See your target retirement year and how +10% savings rate pulls it closer.',
    keywords: ['fire calculator', 'financial independence calculator', 'retire early calculator', 'fire number calculator', '4 percent rule calculator'],
    intent: 'commercial', category: 'Finance Calculators', h1: 'FIRE Calculator (Financial Independence)',
    shortIntro: 'Your FIRE number, target retirement year, and savings-rate math in one screen.', published: true,
    longTailKeywords: [
      'how much do i need to retire early',
      'fire number 25x annual spending',
      'savings rate vs years to retirement',
      'lean fire vs regular fire number',
    ],
    titleLongTail: 'FIRE Number & Early Retirement Date - Savings Rate Simulator',
    descriptionLongTail: 'From your spending, savings, and safe withdrawal rate: your FIRE number, the exact target year, and how much earlier each +10% of savings rate gets you.',
    nextTools: ['compound-interest-calculator', 'retirement-calculator'],
  },
  {
    slug: 'break-even-calculator', name: 'Break-Even Calculator',
    title: 'Break-Even Point Calculator - Units & Revenue Instantly',
    description: 'Calculate your break-even point from fixed costs, price per unit, and variable cost. Get break-even units, revenue, and contribution margin ratio. Free.',
    keywords: ['break even calculator', 'break even point calculator', 'break even analysis', 'contribution margin calculator', 'break even units formula'],
    intent: 'commercial', category: 'Business Tools', h1: 'Break-Even Point Calculator',
    shortIntro: 'Break-even units, revenue, and contribution margin in one pass.', published: true,
    longTailKeywords: [
      'break even point in units formula',
      'break even analysis calculator with fixed and variable costs',
      'contribution margin ratio calculator',
      'how many units to break even',
    ],
    titleLongTail: 'Break-Even Calculator - Units, Revenue & Margin',
    descriptionLongTail: 'Enter fixed costs, unit price, and variable cost to get break-even units and revenue instantly — with contribution margin ratio explained. Free.',
    nextTools: ['profit-margin-calculator', 'markup-calculator'],
  },
  {
    slug: 'profit-margin-calculator', name: 'Profit Margin Calculator',
    title: 'Profit Margin Calculator - Margin & Markup Converter',
    description: 'Enter cost plus price, margin, or markup and get all four figures instantly. Convert margin to markup and back — the pricing tool every seller needs. Free.',
    keywords: ['profit margin calculator', 'markup calculator', 'margin calculator', 'gross margin calculator', 'margin vs markup'],
    intent: 'commercial', category: 'Business Tools', h1: 'Profit Margin & Markup Calculator',
    shortIntro: 'Cost + any one value → price, profit, margin, and markup.', published: true,
    longTailKeywords: [
      'margin to markup converter',
      'profit margin calculator from cost and selling price',
      'how to calculate profit margin per unit',
      'target margin pricing calculator',
    ],
    titleLongTail: 'Profit Margin Calculator - Margin ↔ Markup in One Click',
    descriptionLongTail: 'Enter your cost and any one of price, margin, or markup — profit, multiplier, and the other figures fill in instantly. Free, no signup.',
    nextTools: ['markup-calculator', 'break-even-calculator'],
  },
  {
    slug: 'cac-ltv-calculator', name: 'CAC & LTV Calculator',
    title: 'CAC & LTV Calculator - LTV:CAC Ratio with 3:1 Benchmark',
    description: 'Compute customer acquisition cost, lifetime value, CAC payback months, and the LTV:CAC ratio with the 3:1 golden-rule benchmark for SaaS and e-commerce. Free.',
    keywords: ['ltv cac calculator', 'customer acquisition cost calculator', 'customer lifetime value calculator', 'ltv to cac ratio', 'saas unit economics calculator'],
    intent: 'commercial', category: 'Business Tools', h1: 'CAC & LTV Calculator (LTV:CAC Ratio)',
    shortIntro: 'CAC, LTV, payback months, and the LTV:CAC health gauge in one screen.', published: true,
    longTailKeywords: [
      'ltv cac ratio 3 to 1 rule',
      'how to calculate ltv from churn and arpu',
      'cac payback period calculator',
      'saas unit economics benchmark tool',
    ],
    titleLongTail: 'LTV:CAC Ratio Calculator - Is Your Growth Engine Healthy?',
    descriptionLongTail: 'Enter spend, new customers, ARPU, gross margin, and churn: get CAC, margin-adjusted LTV, payback months, and a verdict against the 3:1 golden rule.',
    nextTools: ['profit-margin-calculator', 'break-even-calculator'],
  },
  ...
  },
  {
    ...
    title: 'Fuel Cost Calculator - Trip & Commute Gas Money',
    description: 'Work out fuel money for any trip or commute: distance, efficiency, and price per gallon or liter. Split costs across passengers instantly. Free.',
    keywords: ['fuel cost calculator', 'gas cost calculator', 'trip fuel cost', 'commute gas money', 'road trip cost'],
    intent: 'informational', category: 'Finance Calculators', h1: 'Fuel Cost Calculator',
    shortIntro: 'Gas money for any trip — one-way, round trip, split per person.', published: true,
    longTailKeywords: [
      'how much gas will my road trip cost',
      'monthly commute fuel cost',
      'split petrol costs between passengers',
      'cost of driving per km calculator',
    ],
    titleLongTail: 'Road Trip Gas Calculator - Split Between Passengers',
    descriptionLongTail: 'Enter distance, your car consumption, and local fuel price to see the real cost of a trip or monthly commute — with per-passenger splitting built in.',
  },
  {
    slug: 'subscription-cost-calculator', name: 'Subscription Cost Calculator',
    title: 'Subscription Cost Calculator - What Your Subscriptions Really Cost',
    description: 'Add up every streaming service, app, and membership to see your true monthly and yearly subscription spend. Spot silent budget leaks in seconds.',
    keywords: ['subscription cost calculator', 'subscription tracker', 'monthly subscriptions cost', 'recurring expenses calculator', 'streaming services cost'],
    intent: 'informational', category: 'Finance Calculators', h1: 'Subscription Cost Calculator',
    shortIntro: 'Total up every subscription and see the yearly damage.', published: true,
    longTailKeywords: [
      'how much do i spend on subscriptions per year',
      'add up monthly subscriptions',
      'are subscriptions worth it calculator',
      'cancel unused subscriptions savings',
    ],
    titleLongTail: 'Monthly Subscription Spending - Yearly Total View',
    descriptionLongTail: 'List each service with its billing cycle and the calculator converts everything to monthly and yearly totals. The yearly number is usually the eye-opener.',
  },
  {
    slug: 'overtime-calculator', name: 'Overtime Pay Calculator',
    title: 'Overtime Pay Calculator - Time-and-a-Half & Double Time',
    description: 'Calculate overtime pay at 1.5x, 2x, or a custom multiplier. Enter your hourly rate or salary and regular plus OT hours to see total weekly pay.',
    keywords: ['overtime calculator', 'overtime pay calculator', 'time and a half calculator', 'double time pay', 'ot rate calculator'],
    intent: 'informational', category: 'Finance Calculators', h1: 'Overtime Pay Calculator',
    shortIntro: 'Weekly pay with time-and-a-half, double time, or custom multipliers.', published: true,
    longTailKeywords: [
      'time and a half for 10 hours pay',
      'overtime on salary calculator',
      'double time holiday pay calculator',
      'blended overtime rate calculator',
    ],
    titleLongTail: 'Time and a Half Calculator - Overtime From Salary or Hourly',
    descriptionLongTail: 'Works from hourly wage or annual salary, applies your OT multiplier to extra hours, and shows regular vs overtime pay side by side for the week.',
  },
  {
    slug: 'take-home-pay-calculator', name: 'Take-Home Pay Calculator',
    title: 'Take-Home Pay Calculator - Net Pay After Deductions',
    description: 'Estimate your paycheck after federal tax withholding, Social Security, Medicare, and pre-tax deductions like 401(k) and health premiums. US-focused estimate.',
    keywords: ['take home pay calculator', 'net pay calculator', 'paycheck calculator', 'salary after taxes', '401k paycheck impact'],
    intent: 'informational', category: 'Finance Calculators', h1: 'Take-Home Pay Calculator',
    shortIntro: 'Estimate net pay after federal tax, FICA, and pre-tax deductions.', published: true,
    longTailKeywords: [
      'biweekly paycheck calculator after taxes',
      '401k contribution take home effect',
      'salary to net pay estimator',
      'fica deduction calculator on paycheck',
    ],
  ...
  },
  {
    ...
    title: 'Wedding Budget Calculator - Allocate Your Budget by Category',
    description: 'Split your wedding budget across venue, catering, photography, attire, and more with industry-standard percentages. See dollar amounts per category instantly.',
    keywords: ['wedding budget calculator', 'wedding budget breakdown', 'how to split wedding budget', 'wedding cost allocation', 'venue catering budget'],
    intent: 'informational', category: 'Finance Calculators', h1: 'Wedding Budget Calculator',
    shortIntro: 'Turn your total into per-category amounts with typical percentages.', published: true,
    longTailKeywords: [
      'average wedding budget breakdown percentages',
      '20000 wedding budget breakdown',
      'how much to spend on venue vs catering',
      'wedding budget planner by category',
    ],
    titleLongTail: 'Wedding Budget Breakdown - Venue, Catering, Photo Percentages',
    descriptionLongTail: 'Enter your total budget and guest count; get a realistic allocation across the eight biggest categories, with editable weights for what matters most to you.',
  },
  {
    slug: 'amortization-table-generator', name: 'Amortization Table Generator',
    title: 'Amortization Table Generator - Full Payment Schedule CSV',
    description: 'Generate a complete loan amortization schedule: payment-by-payment principal and interest, running balance, and export to CSV for Excel or Sheets.',
    keywords: ['amortization table generator', 'loan amortization schedule', 'payment schedule calculator', 'principal interest breakdown', 'amortization csv'],
    intent: 'informational', category: 'Finance Calculators', h1: 'Amortization Table Generator',
    shortIntro: 'Full payment-by-payment schedule with running balance, CSV export.', published: true,
    longTailKeywords: [
      'mortgage amortization table excel',
      'monthly payment breakdown principal interest',
      'loan payoff schedule by month',
      'remaining balance amortization chart',
    ],
    titleLongTail: 'Loan Payment Schedule - Principal vs Interest by Month',
    descriptionLongTail: 'See exactly where every payment goes over the life of a mortgage, auto, or personal loan — early payments are mostly interest, and this table proves it.',
  },
  {
    slug: 'heart-rate-zone-calculator', name: 'Heart Rate Zone Calculator',
    title: 'Heart Rate Zone Calculator - Training Zones 1-5 (Karvonen)',
    description: 'Find your five heart-rate training zones using the Karvonen method with resting heart rate, plus simple max-heart-rate estimates. For runners and cyclists.',
    keywords: ['heart rate zone calculator', 'karvonen formula', 'training zones calculator', 'zone 2 heart rate', 'max heart rate'],
    intent: 'informational', category: 'Health Calculators', h1: 'Heart Rate Zone Calculator',
    shortIntro: 'Your five training zones, personalized with resting heart rate.', published: true,
    longTailKeywords: [
      'zone 2 training heart rate calculator',
      'karvonen formula zones',
      'max hr 220 minus age accurate',
      'fat burning zone heart rate',
    ],
    titleLongTail: 'Zone 2 Heart Rate - Karvonen Zones by Age & Resting HR',
    descriptionLongTail: 'Resting heart rate makes zones personal: enter age and morning pulse for Karvonen zones Z1-Z5, plus what each zone actually trains.',
  },
  {
    slug: 'caffeine-calculator', name: 'Caffeine Calculator',
    title: 'Caffeine Calculator - How Much Caffeine Is In You Right Now',
    description: 'Track caffeine in your body over time. Enter drinks and times to see current level based on a 5-hour half-life, plus when caffeine drops below your cutoff.',
    keywords: ['caffeine calculator', 'caffeine half life', 'how much caffeine in my body', 'coffee wear off time', 'caffeine before bed'],
    intent: 'informational', category: 'Health Calculators', h1: 'Caffeine Calculator',
    shortIntro: 'Estimate the caffeine still in your system right now.', published: true,
    longTailKeywords: [
      'when will coffee wear off calculator',
      'caffeine at 3pm still awake',
      'half life of caffeine 5 hours',
      'safe caffeine cut off time before bed',
    ],
    titleLongTail: 'When Does Coffee Wear Off? Caffeine Half-Life Timeline',
    descriptionLongTail: 'Log your coffees, teas, and energy drinks; see your body-wide milligrams now and at bedtime using the clinically observed ~5-hour half-life.',
  },
  {
    slug: 'intermittent-fasting-calculator', name: 'Intermittent Fasting Calculator',
    title: 'Intermittent Fasting Calculator - 16:8 Schedule & Timeline',
    description: 'Build your intermittent fasting schedule for 16:8, 18:6, 20:4, or 14:10. Get eating windows, a live fasting countdown, and the ketosis-autophagy timeline. Free.',
    keywords: ['intermittent fasting calculator', 'fasting schedule calculator', '16:8 fasting schedule', 'fasting timer', 'eating window calculator'],
    intent: 'informational', category: 'Health Calculators', h1: 'Intermittent Fasting Schedule Calculator',
    shortIntro: '16:8 / 18:6 / 20:4 schedules with countdown and metabolic timeline.', published: true,
    longTailKeywords: [
      '16:8 intermittent fasting schedule times',
      'intermittent fasting window calculator',
      'when does ketosis start during fasting',
      'fasting schedule based on first meal',
    ],
    titleLongTail: 'Intermittent Fasting Calculator - 16:8 / 18:6 Schedule',
    descriptionLongTail: 'Enter your first meal time and protocol to get your eating window, a live fasting countdown, and when fat burning and autophagy kick in. Free.',
    nextTools: ['calorie-calculator', 'bmi-calculator'],
  },
  {
    slug: 'steps-to-calories-calculator', name: 'Steps to Calories Calculator',
    title: 'Steps to Calories Calculator - Walking Calories by Steps & Weight',
    description: 'Convert daily steps to calories burned and distance covered. Accounts for your weight and step length — 10,000 steps is not the same for everyone.',
    keywords: ['steps to calories calculator', '10000 steps calories', 'walking calorie calculator', 'steps to km', 'steps to miles'],
    intent: 'informational', category: 'Health Calculators', h1: 'Steps to Calories Calculator',
    shortIntro: 'Steps → calories and distance, adjusted for your body.', published: true,
    longTailKeywords: [
      'how many calories does 10000 steps burn',
      'steps to miles converter walking',
      '8000 steps calories burned weight loss',
      'walking 5km is how many steps',
    ],
    titleLongTail: 'How Many Calories Do 10,000 Steps Burn? By Weight',
    descriptionLongTail: 'Enter steps, height, weight, and pace: get distance in km/miles and a defensible calorie estimate instead of fitness-band guesses.',
  },
  {
    slug: 'paint-calculator', name: 'Paint Calculator',
    title: 'Paint Calculator - How Many Gallons or Liters You Need',
    description: 'Estimate paint needed for a room from wall dimensions, doors and windows, and number of coats. Works in gallons or liters with waste margin built in.',
    keywords: ['paint calculator', 'how much paint do i need', 'wall paint coverage', 'gallons of paint per room', 'paint per square meter'],
    intent: 'informational', category: 'Home Calculators', h1: 'Paint Calculator',
    shortIntro: 'Gallons or liters of paint for a room, coats and openings counted.', published: true,
    longTailKeywords: [
      'how many gallons paint 12x12 room',
      'paint coverage per litre calculator',
      'two coats paint quantity estimator',
      'subtract door window wall area paint',
    ],
    titleLongTail: 'Interior Paint Estimator - Coats, Openings & Coverage Rate',
    descriptionLongTail: 'Enter wall dimensions and openings; we subtract doors/windows, multiply by coats, apply the paint-can coverage rate, and round up to buyable quantities.',
  },
  {
    slug: 'flooring-calculator', name: 'Flooring Calculator',
    title: 'Flooring Calculator - How Many Boxes of Tile or Plank?',
    description: 'Estimate flooring for any room: area in ft² and m², waste factor, boxes needed for tile, hardwood, vinyl, or marble, and the total material budget. Free.',
    keywords: ['flooring calculator', 'tile calculator', 'how many boxes of flooring do i need', 'flooring cost calculator', 'laminate square footage calculator'],
    intent: 'commercial', category: 'Home Calculators', h1: 'Flooring & Tile Calculator',
    shortIntro: 'Room size + waste factor → boxes needed and material budget (ft²/m²).', published: true,
    longTailKeywords: [
      'how many boxes laminate for 200 sq ft',
      'tile square footage calculator with waste',
      'flooring boxes calculator per square meter',
      'vinyl plank quantity estimator',
    ],
    titleLongTail: 'Box-Count Flooring & Tile Estimator (Waste Factor Built In)',
    descriptionLongTail: 'Measure your room once: we convert to ft² and m², add your waste percentage, and round up to whole boxes of tile, hardwood, vinyl, or marble with cost.',
    nextTools: ['paint-calculator', 'area-converter'],
  },
  {
    slug: 'dog-age-calculator', name: 'Dog Age Calculator',
    title: 'Dog Age Calculator - Real Dog to Human Years by Breed Size',
    description: 'Convert dog years to human years properly — the ×7 rule is wrong. Uses AVMA size-based curves for small, medium, and large breeds.',
    keywords: ['dog age calculator', 'dog years to human years', 'how old is my dog', 'dog age chart', 'puppy age calculator'],
    intent: 'informational', category: 'Pet Tools', h1: 'Dog Age Calculator',
    shortIntro: 'Dog-to-human age conversion that respects breed size — no ×7 myth.', published: true,
    longTailKeywords: [
      'how old is my dog in human years',
      '7 dog years myth wrong',
      'large breed dog aging faster',
      'puppy to human age chart by size',
    ],
    titleLongTail: 'Dog Years to Human Years - By Breed Size (Not ×7)',
    descriptionLongTail: 'Dogs mature fast early then slow down, and big breeds age quicker than small ones. Enter breed size and age for an evidence-based comparison.',
  },
  {
    slug: 'dog-food-calculator', name: 'Dog Food Calculator',
    title: 'Dog Food Calculator - Daily Calories, Cups & Grams',
    description: 'Science-based dog feeding calculator: RER and MER from weight, neuter status, and activity, converted to daily cups and grams from your food\'s kcal density.',
    keywords: ['dog food calculator', 'how much should i feed my dog', 'dog calorie calculator', 'dog feeding chart by weight', 'dog mer calculator'],
    intent: 'informational', category: 'Pet Tools', h1: 'Dog Food & Calorie Calculator',
    shortIntro: 'Weight + life stage → daily kcal, cups, and grams per your food label.', published: true,
    longTailKeywords: [
      'how many cups of dog food per day',
      'dog mer calculation formula',
      'dog calorie needs by weight kg',
      'kcal per cup to grams dog food',
    ],
    titleLongTail: 'How Much Should I Feed My Dog? kcal → Cups & Grams',
    descriptionLongTail: 'Enter weight, neuter status, and activity for daily calories (MER), then convert your food\'s kcal-per-cup or kcal-per-100g label into cups and grams.',
    nextTools: ['dog-age-calculator'],
  },
  {
    slug: 'keycode-info', name: 'Keyboard Event Info (Keycode)',
    title: 'JavaScript Keycode Checker - Test Any Keyboard Key',
    description: 'Press any key to see its event.key, event.code, keyCode, and modifier states. The fastest way to debug keyboard shortcuts and key handling. Free.',
    keywords: ['javascript keycode', 'event.key checker', 'keyboard event tester', 'keycode list', 'which key was pressed'],
    intent: 'informational', category: 'Developer Tools', h1: 'Keyboard Event Tester',
    shortIntro: 'Press any key — see key, code, keyCode, and modifiers live.', published: true,
    longTailKeywords: [
      'what is my keycode',
      'event.key vs event.code difference',
      'enter key javascript keycode value',
      'test keyboard events online',
    ],
    titleLongTail: 'Keycode Test - event.key / event.code / keyCode Live View',
    descriptionLongTail: 'Focus the box and press keys: get live event.key, physical code, legacy keyCode, and modifier flags for shortcut debugging. Nothing is sent anywhere.',
  },
  {
    slug: 'mime-type-lookup', name: 'MIME Type Lookup',
    title: 'MIME Type Lookup - File Extension to Content-Type',
    description: 'Look up the correct MIME content-type for any file extension, or search by MIME type. Covers web, document, media, and archive formats. Free reference.',
    keywords: ['mime type lookup', 'content type list', 'file extension mime', 'application json', 'http content type'],
    intent: 'informational', category: 'Developer Tools', h1: 'MIME Type Lookup',
    shortIntro: 'Extension ↔ MIME type mapping for HTTP headers and configs.', published: true,
    longTailKeywords: [
      'mime type for svg files',
      'correct content type for json api',
      'web server mime types nginx',
      'woff2 font mime type',
    ],
    titleLongTail: 'Content-Type Reference - Web, Font, Media & Data Formats',
    descriptionLongTail: 'Searchable table of MIME types with the exact strings servers and code expect — including the ones people get wrong (js vs mjs, woff2, manifests).',
  },
  {
    slug: 'xml-formatter', name: 'XML Formatter & Validator',
    title: 'XML Formatter - Beautify, Minify & Validate XML Online',
    description: 'Format XML with custom indentation, minify it for transport, or validate syntax with precise error messages. All parsing runs locally in your browser.',
    keywords: ['xml formatter', 'format xml online', 'xml beautifier', 'xml validator', 'minify xml'],
    intent: 'informational', category: 'Developer Tools', h1: 'XML Formatter & Validator',
    shortIntro: 'Pretty-print, minify, or pinpoint-validate XML documents.', published: true,
    longTailKeywords: [
      'online xml pretty print indented',
      'xml syntax error checker line number',
      'minify xml for soap request',
      'format sitemap xml readable',
    ],
    titleLongTail: 'Beautify XML - Custom Indent, Error Line Numbers',
    descriptionLongTail: 'Paste XML to re-indent it cleanly, collapse it to a single line, or find exactly where it breaks. DOMParser-powered with browser-grade error reporting.',
  },
  {
    slug: 'markdown-toc-generator', name: 'Markdown TOC Generator',
    title: 'Markdown Table of Contents Generator - Anchored Heading List',
    description: 'Paste Markdown to instantly generate a linked table of contents from your headings, with GitHub-compatible anchor slugs and configurable depth.',
    keywords: ['markdown toc generator', 'table of contents markdown', 'github anchor links', 'markdown heading links', 'readme outline'],
    intent: 'informational', category: 'Text Tools', h1: 'Markdown TOC Generator',
    shortIntro: 'Linked outline from your headings, GitHub-slug compatible.', published: true,
    longTailKeywords: [
      'generate table of contents readme',
      'markdown heading anchor generator',
      'github markdown internal links',
      'nested toc from markdown headings',
    ],
    titleLongTail: 'Create Linked TOC for README & Blog Markdown Files',
    descriptionLongTail: 'Handles duplicate headings (the -1 suffix rule), strips formatting inside headings, and emits indentation that renders correctly on GitHub.',
  },
  {
    slug: 'log-filter-tool', name: 'Log Filter & Grep Tool',
    title: 'Log Filter - Grep-style Search Through Log Files Online',
    description: 'Paste logs and filter by keyword, regex, log level, or time range. Highlight matches, exclude noise, and copy just what matters. Private — nothing uploads.',
    keywords: ['log filter', 'grep online', 'log file analyzer', 'filter log viewer', 'regex log search'],
    intent: 'informational', category: 'Developer Tools', h1: 'Log Filter & Grep Tool',
    shortIntro: 'Grep-style filtering for logs — keyword, level, or regex.', published: true,
    longTailKeywords: [
      'search through large log file online',
      'filter error lines from logs',
      'client side log analysis tool',
      'exclude debug lines grep invert',
    ],
    titleLongTail: 'Analyze Logs Locally - Level Filters & Inverted Match',
    descriptionLongTail: 'Sensitive logs never belong on random websites — this one parses entirely in your browser. Filter by level, include/exclude patterns, and copy results.',
  },
  {
    slug: 'ascii-table', name: 'ASCII Table',
    title: 'ASCII Table - Character Codes Reference with Search',
    description: 'Complete ASCII table: decimal, hex, binary, octal codes for every character, searchable and click-to-copy. Control chars included with names.',
    keywords: ['ascii table', 'ascii character codes', 'hex to ascii chart', 'decimal char codes', 'binary ascii'],
    intent: 'informational', category: 'Developer Tools', h1: 'ASCII Table & Character Codes',
    shortIntro: 'Every ASCII character with dec/hex/oct/bin codes, searchable.', published: true,
    longTailKeywords: [
      'ascii code for enter key newline',
      'a to z ascii values list',
      'hex 0x41 what character',
      'printable ascii characters range',
    ],
    titleLongTail: 'ASCII Chart - Decimal, Hexadecimal, Binary Values',
    descriptionLongTail: 'Search by character or code in any base; every cell copies on click. Includes named control characters (NUL, CR, LF) and extended notes.',
  },
  {
    slug: 'screen-time-calculator', name: 'Screen Time Calculator',
    title: 'Screen Time Calculator - Your Daily Hours as Years of Life',
    description: 'Enter daily screen or phone hours and see them as years over your lifetime — plus what reclaiming one hour a day actually adds up to.',
    keywords: ['screen time calculator', 'phone usage calculator', 'average screen time statistics', 'hours spent on phone yearly', 'digital wellbeing'],
    intent: 'informational', category: 'Time Calculators', h1: 'Screen Time Calculator',
    shortIntro: 'Daily scrolling hours, translated into years of your life.', published: true,
    longTailKeywords: [
      'how many years do i spend on my phone',
      '4 hours screen time per day yearly total',
      'average person phone hours per week',
      'screen time life expectancy visualization',
    ],
    titleLongTail: 'Hours on Your Phone Per Year - Lifetime Projection',
    descriptionLongTail: 'Four hours a day is 61 full days a year — about two months awake-time. Project your own numbers across decades and test reclaim scenarios.',
  },
  {
    slug: 'reading-level-checker', name: 'Reading Level Checker',
    title: 'Readability Checker - Flesch Reading Ease & Grade Level',
    description: 'Paste text to get Flesch Reading Ease, Flesch-Kincaid grade level, word/sentence stats, and the longest sentences dragging your score down.',
    keywords: ['reading level checker', 'flesch reading ease', 'flesch kincaid calculator', 'text readability score', 'grade level checker'],
    intent: 'informational', category: 'Text Tools', h1: 'Reading Level Checker',
    shortIntro: 'Flesch scores and grade level with sentence-level breakdown.', published: true,
    longTailKeywords: [
      'check readability of my writing',
      'what grade level is my text',
      'flesch kincaid score meaning',
      'simplify writing readability score free',
    ],
    titleLongTail: 'Text Readability Score - Sentence Length & Syllable Analysis',
    descriptionLongTail: 'Scores run fully offline using standard formulas. Aim for 60-70 reading ease (~8th grade) for general audiences; technical docs legitimately run lower.',
  },
  {
    slug: 'hmac-generator', name: 'HMAC Generator',
    title: 'HMAC Generator - SHA-256/384/512 HMAC Signatures Online',
    description: 'Compute HMAC signatures with SHA-256, SHA-384, or SHA-512 via native WebCrypto. Verify webhook payloads or API signatures without installing anything.',
    keywords: ['hmac generator', 'hmac sha256 online', 'webhook signature verify', 'hmac hash message authentication', 'api signature calculator'],
    intent: 'informational', category: 'Security Tools', h1: 'HMAC Generator',
    shortIntro: 'HMAC-SHA256/384/512 signatures via native WebCrypto.', published: true,
    longTailKeywords: [
      'verify stripe webhook signature manually',
      'compute hmac sha256 of string',
      'secret key message digest generator',
      'hmac vs hash difference explained',
    ],
    titleLongTail: 'Webhook Signature Testing - HMAC with Hex/Base64 Output',
    descriptionLongTail: 'Enter message and secret key, pick an algorithm, and get the HMAC in hex or base64 — matching what Stripe, Slack, GitHub, and AWS compute server-side.',
  },
  {
    slug: 'jwt-generator', name: 'JWT Generator',
    title: 'JWT Generator - Create HS256/384/512 Tokens Online',
    description: 'Build signed JSON Web Tokens with HMAC algorithms via native WebCrypto. Edit header and payload JSON, add a secret, get the token instantly. Local only.',
    keywords: ['jwt generator', 'create jwt online', 'hs256 token generator', 'jwt sign tool', 'json web token builder'],
    intent: 'informational', category: 'Developer Tools', h1: 'JWT Generator',
    shortIntro: 'Craft signed JWTs locally — pairs with our decoder for testing.', published: true,
    longTailKeywords: [
      'generate jwt for testing',
      'hs256 jwt example with secret',
      'create json web token online free',
      'jwt debug create sign verify',
    ],
    titleLongTail: 'Build & Sign JWTs - Custom Header, Payload & Secret',
    descriptionLongTail: 'Compose header and payload, pick an HMAC algorithm, enter your secret, and copy a properly signed token. Runs on WebCrypto in your browser.',
  },
  {
    slug: 'hash-comparator', name: 'Hash Comparator',
    title: 'Hash Comparator - Verify File & String Checksums Safely',
    description: 'Compare two hashes with constant-time comparison to verify downloads, file integrity, or password digests without timing side channels. Free and private.',
    keywords: ['hash comparator', 'compare checksums', 'verify sha256', 'checksum comparison', 'file integrity check'],
    intent: 'informational', category: 'Security Tools', h1: 'Hash Comparator',
    shortIntro: 'Constant-time comparison of two hashes — no timing leaks.', published: true,
    longTailKeywords: [
      'compare sha256 with expected hash',
      'verify downloaded file checksum',
      'constant time string comparison why',
      'md5 vs sha256 integrity check',
    ],
    titleLongTail: 'Checksum Verifier - Case-insensitive Safe Comparison',
    descriptionLongTail: 'Paste the expected and actual hashes; the comparator normalizes case and whitespace, then reports match/mismatch using constant-time logic.',
  },
  {
    slug: 'base-converter', name: 'Base Converter (Any Base 2-36)',
    title: 'Number Base Converter - Binary, Octal, Decimal, Hex & Any Base',
    description: 'Convert numbers between any bases from 2 to 36, including fractional parts. Simultaneous display of all common bases with digit-by-digit breakdown.',
    keywords: ['base converter', 'binary to decimal', 'hex converter', 'number base conversion', 'base 36'],
    intent: 'informational', category: 'Developer Tools', h1: 'Number Base Converter',
    shortIntro: 'Any base 2-36, fractions included, all common bases at once.', published: true,
    longTailKeywords: [
      'convert base 10 to base 36',
      'fractional binary conversion calculator',
      'decimal to octal with decimals',
      'custom number base converter programming',
    ],
    titleLongTail: 'Binary ↔ Decimal ↔ Hex ↔ Any Base (Fractions Work)',
    descriptionLongTail: 'Type a value in any base 2-36 and see it converted everywhere simultaneously. Fractional digits supported up to high precision.',
  },
  {
    slug: 'cron-expression-generator', name: 'Cron Expression Generator',
    title: 'Cron Expression Generator - Build Cron Schedules Visually',
    description: 'Build cron expressions visually: pick minutes, hours, days and months from friendly controls. Live human-readable preview powered by our own cron engine.',
    keywords: ['cron expression generator', 'cron maker', 'crontab generator', 'cron every 5 minutes', 'schedule expression builder'],
    intent: 'informational', category: 'Developer Tools', h1: 'Cron Expression Generator',
    shortIntro: 'Click-to-build cron schedules with live plain-English preview.', published: true,
    longTailKeywords: [
      'crontab every day at 3am expression',
      'cron every 15 minutes generator',
      'quartz cron vs unix cron format',
      'weekday only cron expression',
    ],
    titleLongTail: 'Visual Crontab Builder - Every N Minutes, Daily, Weekdays',
    descriptionLongTail: 'Common presets plus fine-grained control over each field; the description line updates as you click so you always know what you scheduled.',
  },
  {
    slug: 'htaccess-redirect-generator', name: '.htaccess Redirect Generator',
    title: '.htaccess Redirect Generator - 301 & Rewrite Rules Made Easy',
    description: 'Generate Apache .htaccess redirect rules: single 301s, domain migrations with wildcards, www/non-www canonicalization, and HTTPS forcing. Copy-paste ready.',
    keywords: ['htaccess redirect generator', '301 redirect htaccess', 'apache rewrite rules', 'redirect www to non-www', 'force https htaccess'],
    intent: 'informational', category: 'Developer Tools', h1: '.htaccess Redirect Generator',
    shortIntro: '301s, domain moves, HTTPS and canonical rules without tears.', published: true,
    longTailKeywords: [
      'redirect old domain to new htaccess',
      'htaccess rewrite rule examples',
      'remove index.html from urls htaccess',
      'bulk 301 redirects from csv',
    ],
    titleLongTail: 'Apache 301 Rules - Domain Migration & HTTPS Templates',
    descriptionLongTail: 'Fill in old/new URLs or domains and get production-safe RewriteRule blocks, with flags explained inline so you know what each line does.',
  },
  {
    slug: 'unicode-character-lookup', name: 'Unicode Character Lookup',
    title: 'Unicode Lookup - Find Characters by Name or Code Point',
    description: 'Search Unicode characters by name (arrow, star, checkmark) or paste a character to identify its code point, block, and category. Click any result to copy.',
    keywords: ['unicode lookup', 'unicode character search', 'find unicode by name', 'code point checker', 'special characters list'],
    intent: 'informational', category: 'Developer Tools', h1: 'Unicode Character Lookup',
    shortIntro: 'Find any symbol by name or paste — code point and block shown.', published: true,
    longTailKeywords: [
      'what is this symbol u2014',
      'checkmark unicode copy paste',
      'arrow character code points list',
      'emoji vs unicode difference',
    ],
    titleLongTail: 'Unicode Search - Arrows, Symbols, Punctuation & More',
    descriptionLongTail: 'A curated searchable set covering the characters people actually hunt for: arrows, math, typography, box-drawing, and currency symbols.',
  },
  {
    slug: 'toml-to-json', name: 'TOML to JSON Converter',
    title: 'TOML to JSON Converter - Parse Config Files Online',
    description: 'Convert TOML configuration (Cargo.toml, pyproject.toml style) to JSON instantly. Handles tables, arrays, inline tables, and typed values per the TOML 1.0 spec.',
    keywords: ['toml to json', 'toml parser online', 'cargo toml to json', 'pyproject converter', 'toml validator'],
    intent: 'informational', category: 'Developer Tools', h1: 'TOML to JSON Converter',
    shortIntro: 'Cargo/pyproject-style TOML parsed to clean JSON locally.', published: true,
    longTailKeywords: [
      'convert cargo toml to json online',
      'pyproject toml parser javascript',
      'toml 1.0 spec compliant parser',
      'view toml as json tree',
    ],
    titleLongTail: 'Parse TOML Config Files - Tables, Arrays & Datetimes',
    descriptionLongTail: 'Paste TOML from Rust or Python projects and get structured JSON with precise error locations when syntax breaks. Zero uploads.',
  },
  {
    slug: 'dice-roller', name: 'Dice Roller',
    title: 'Online Dice Roller - D4, D6, D8, D10, D12, D20 & Custom',
    description: 'Roll virtual dice for board games and tabletop RPGs: standard polyhedrals (d4-d100), multiple dice at once, with per-die results and total. Free, no signup.',
    keywords: ['dice roller', 'online dice', 'roll d20', 'virtual dice roller', 'rpg dice'],
    intent: 'informational', category: 'Game Tools', h1: 'Online Dice Roller',
    shortIntro: 'Roll any dice — d4 to d100, multiples at once, fair rolls.', published: true,
    longTailKeywords: [
      'roll a d20 online',
      'dice roller for board games',
      'roll 2d6 online free',
      'virtual dnd dice roller no ads',
    ],
    titleLongTail: 'Virtual Dice - Roll d20, 2d6, d100 with History',
    descriptionLongTail: 'Choose die type and count, roll instantly, see each die plus the total. Uses crypto-grade randomness — fairer than physical chipped dice.',
  },
  {
    slug: 'coin-flip', name: 'Coin Flip',
    title: 'Coin Flip Online - Heads or Tails Decider',
    description: 'Flip a virtual coin with crypto-grade randomness. Flip once or in batches, keep a running tally of heads and tails. The fastest fair decider online.',
    keywords: ['coin flip', 'flip a coin', 'heads or tails', 'coin toss online', 'random decider'],
    intent: 'informational', category: 'Game Tools', h1: 'Coin Flip',
    shortIntro: 'A crisp instant heads-or-tails with a running tally.', published: true,
    longTailKeywords: [
      'flip a coin 100 times',
      'heads or tails online decider',
      'best of three coin flip',
      'random yes no coin toss',
    ],
    titleLongTail: 'Heads or Tails? Fair Virtual Coin Toss',
    descriptionLongTail: 'One click, one fair flip — backed by cryptographic randomness rather than predictable Math.random shortcuts. Tally tracks your session.',
  },
  {
    slug: 'wheel-spinner', name: 'Wheel Spinner',
    title: 'Wheel Spinner - Random Name Picker & Decision Wheel',
    description: 'Enter names, foods, tasks — anything — and spin an animated wheel to pick one at random. Great for classrooms, giveaways, and indecisive groups.',
    keywords: ['wheel spinner', 'random name picker', 'spin the wheel', 'decision wheel', 'raffle picker'],
    intent: 'informational', category: 'Game Tools', h1: 'Wheel Spinner',
    shortIntro: 'Spin to decide: names, chores, restaurants — fairly chosen.', published: true,
    longTailKeywords: [
      'spin the wheel random name picker',
      'classroom roulette wheel online',
      'giveaway winner picker wheel',
      'what should i eat spinner',
    ],
    titleLongTail: 'Random Picker Wheel - Free & Instant Decision Maker',
    descriptionLongTail: 'Type up to a dozen options, hit spin, and let physics-flavored animation land on a cryptographically fair winner. Winner is removed optionally.',
  },
  {
    slug: 'morse-code-translator', name: 'Morse Code Translator',
    title: 'Morse Code Translator - Text to Morse & Back Instantly',
    description: 'Translate text to International Morse Code and decode Morse back to text. Plays audio beeps, shows dot-dash patterns, supports letters, digits, prosigns.',
    keywords: ['morse code translator', 'text to morse', 'morse code converter', 'morse audio player', 'sos morse'],
    intent: 'informational', category: 'Text Tools', h1: 'Morse Code Translator',
    shortIntro: 'Two-way Morse translation with dot-dash view and beep audio.', published: true,
    longTailKeywords: [
      'translate english to morse code',
      'morse code sos meaning',
      'play morse code sound online',
      'decode morse from dots and dashes',
    ],
    titleLongTail: 'Write & Decode Morse Code - With Audio Playback',
    descriptionLongTail: 'Letters, digits, punctuation all mapped per the International Morse standard; the play button beeps proper timing so you can learn by ear.',
  },
  {
    slug: 'typing-speed-test', name: 'Typing Speed Test',
    title: 'Typing Speed Test - Measure Your WPM & Accuracy',
    description: 'One-minute typing test measuring words per minute and accuracy against real sentences. No signup, no ads mid-test, instant results with error breakdown.',
    keywords: ['typing speed test', 'wpm test', 'words per minute typing', 'typing practice', 'typing accuracy test'],
    intent: 'informational', category: 'Text Tools', h1: 'Typing Speed Test',
    shortIntro: 'One-minute WPM and accuracy test — clean and ad-free.', published: true,
    longTailKeywords: [
      'how fast do i type wpm test',
      'average typing speed adults',
      'free 1 minute typing test online',
      'improve typing speed accuracy practice',
    ],
    titleLongTail: 'Free Typing Test - Gross vs Net WPM Explained',
    descriptionLongTail: 'Real-sentence prompts, live character highlighting, and honest net-WPM math (errors subtract). The average typist lands 38-42 WPM.',
  },
  {
    slug: 'random-team-generator', name: 'Random Team Generator',
    title: 'Random Team Generator - Split Names into Balanced Groups',
    description: 'Paste a list of names and split them into fair random teams. Choose team count or size, shuffle freely until satisfied, copy results anywhere.',
    keywords: ['random team generator', 'team splitter', 'group maker', 'random group generator', 'split names into teams'],
    intent: 'informational', category: 'Game Tools', h1: 'Random Team Generator',
    shortIntro: 'Fairly split any list into teams — reshuffle till it feels right.', published: true,
    longTailKeywords: [
      'split class into random groups',
      'team generator from name list',
      'assign players to teams randomly',
      'group students into equal teams online',
    ],
    titleLongTail: 'Group Maker - Divide Names into N Random Teams',
    descriptionLongTail: 'Uses Fisher-Yates shuffling for genuinely even distribution, balances team sizes automatically, and never favors the first names entered.',
  },
  {
    slug: 'password-entropy-checker', name: 'Password Entropy Checker',
    title: 'Password Entropy Calculator - Real Strength in Bits, Not Colors',
    description: 'Measure password strength as information entropy in bits: length, charset pool, and pattern penalties. Understand time-to-crack honestly, offline only.',
    keywords: ['password entropy calculator', 'entropy bits password', 'password strength bits', 'time to crack password', 'passphrase entropy'],
    intent: 'informational', category: 'Security Tools', h1: 'Password Entropy Checker',
    shortIntro: 'Entropy in bits — the honest measure of password strength.', published: true,
    longTailKeywords: [
      'how many bits is my password',
      'diceware passphrase entropy calculator',
      'is 12 character password enough',
      'password entropy formula explained',
    ],
    titleLongTail: 'Password Strength in Bits - Entropy Math Explained',
    descriptionLongTail: 'Length × charset pool gives baseline bits; repeats, sequences, and common words deduct. Everything computes locally — typing here is safe.',
  },
  {
    slug: 'llm-cost-calculator', name: 'LLM API Cost Calculator',
    title: 'LLM API Cost Calculator - Compare GPT, Claude & Gemini Pricing',
    description: 'Estimate LLM API costs per request, per day, and per month across GPT, Claude, Gemini, DeepSeek, Kimi, Qwen and GLM. Live price table, cached-input savings included.',
    keywords: ['llm cost calculator', 'openai api pricing calculator', 'claude api cost', 'gpt token cost', 'llm price comparison'],
    intent: 'commercial', category: 'AI Tools', h1: 'LLM API Cost Calculator',
    shortIntro: 'Per-request and monthly API costs across 17 models, side by side.', published: true,
    longTailKeywords: [
      'how much does gpt api cost per month',
      'claude vs gpt api price comparison',
      'llm api cost estimation tool',
      'token cost calculator openai anthropic',
    ],
    titleLongTail: 'API Cost Estimator - GPT vs Claude vs Gemini vs DeepSeek',
    descriptionLongTail: 'Enter your token volumes once and see what every major model would charge — including per-day and per-month projections and cached-input discounts.',
  },
  {
    slug: 'llm-api-cost-calculator', name: 'LLM API Cost Comparison',
    title: 'LLM API Cost Comparison 2026 - Monthly Bills Ranked',
    description: 'Compare monthly LLM API bills across GPT, Claude, Gemini, DeepSeek, Kimi, Qwen and GLM. Enter token volumes once and rank every model by real cost. Free.',
    keywords: ['llm api cost comparison', 'llm pricing comparison 2026', 'openai vs anthropic cost', 'gpt vs claude vs gemini price', 'api bill calculator'],
    intent: 'commercial', category: 'AI Tools', h1: 'LLM API Cost Comparison 2026',
    shortIntro: 'Rank every major model by your real monthly API bill.', published: true,
    longTailKeywords: [
      'llm api cost comparison 2026',
      'monthly openai api bill estimator',
      'cheapest llm api per million tokens',
      'gpt vs claude vs gemini monthly cost',
    ],
    titleLongTail: 'LLM API Cost Comparison 2026 - Monthly Bills Ranked',
    descriptionLongTail: 'Enter monthly input and output token volumes and instantly rank GPT, Claude, Gemini, DeepSeek and more by projected bill — savings gaps included. Free.',
    nextTools: ['llm-cost-calculator', 'context-window-checker'],
  },
  {
    slug: 'context-window-checker', name: 'Context Window Checker',
    title: 'Context Window Checker - Does Your Text Fit the Model?',
    description: 'Paste text or code and see exactly how it fills each model context window — GPT, Claude, Gemini and more — with token estimates and remaining-room percentages.',
    keywords: ['context window checker', 'llm token limit', 'how many tokens is my text', 'context length calculator', 'prompt too long'],
    intent: 'informational', category: 'AI Tools', h1: 'Context Window Checker',
    shortIntro: 'Token count vs every model context limit, with headroom percentages.', published: true,
    longTailKeywords: [
      'is my prompt too long for gpt',
      'tokens vs context window size',
      '8k vs 128k context how much fits',
      'claude context limit checker',
    ],
    titleLongTail: 'Prompt Length vs Model Limits - Tokens & Headroom',
    descriptionLongTail: 'One paste, all limits: see your token estimate against each model window with a fill-percentage bar — before you hit the 400 error in production.',
  },
  {
    slug: 'json-to-zod', name: 'JSON to Zod Schema',
    title: 'JSON to Zod Converter - Generate Schemas from JSON',
    description: 'Turn any JSON into a ready-to-use Zod schema: proper types, nested objects and arrays. Perfect for AI structured output and API validation.',
    keywords: ['json to zod', 'zod schema generator', 'zod converter', 'json schema to zod', 'zod typescript'],
    intent: 'informational', category: 'AI Tools', h1: 'JSON to Zod Schema Converter',
    shortIntro: 'Paste JSON, get a typed Zod schema — AI output validation ready.', published: true,
    longTailKeywords: [
      'convert json to zod schema online',
      'zod schema from json example',
      'validate openai structured output zod',
      'zod object from json typescript',
    ],
    titleLongTail: 'Generate Zod Schema from JSON - Nested Objects & Arrays',
    descriptionLongTail: 'Generates clean zod code with z.object, z.array, unions for mixed types, and .nullable() where null appears — copy straight into a TypeScript project.',
  },
  {
    slug: 'aes-encrypt-decrypt', name: 'AES Encrypt & Decrypt',
    title: 'AES Encryption Online - Encrypt & Decrypt Text (AES-GCM)',
    description: 'Encrypt and decrypt text with AES-256-GCM in your browser via native WebCrypto. PBKDF2 key derivation, authenticated encryption, password never leaves the page.',
    keywords: ['aes encryption online', 'aes decrypt tool', 'aes 256 encryption', 'encrypt text with password', 'aes-gcm'],
    intent: 'informational', category: 'Security Tools', h1: 'AES Encrypt & Decrypt',
    shortIntro: 'AES-256-GCM in-browser: authenticated, PBKDF2-keyed, zero upload.', published: true,
    longTailKeywords: [
      'encrypt text with password aes online',
      'aes gcm decrypt base64',
      'client side encryption tool no upload',
      '256 bit encryption online free',
    ],
    titleLongTail: 'Encrypt Text with Password - AES-256-GCM, Fully Offline',
    descriptionLongTail: 'Derives a 256-bit key from your passphrase with PBKDF2 (150k iterations), encrypts with authenticated GCM, and outputs portable base64. Decryption validates the tag — tampered input fails loudly.',
  },
  {
    slug: 'car-cost-calculator', name: 'Car Cost Calculator',
    title: 'Car Cost Calculator - True Monthly & Yearly Cost of Owning',
    description: 'The real cost of a car beyond the payment: fuel, insurance, maintenance, depreciation, registration and financing combined into monthly and per-km figures.',
    keywords: ['car cost calculator', 'true cost of ownership car', 'monthly car expenses calculator', 'cost per km driving', 'car depreciation calculator'],
    intent: 'informational', category: 'Finance Calculators', h1: 'Car Cost Calculator',
    shortIntro: 'Total ownership cost: fuel, insurance, maintenance, depreciation, financing.', published: true,
    longTailKeywords: [
      'how much does a car really cost per month',
      'true cost of owning a car calculator',
      'cost per kilometer car ownership',
      'new vs used car 5 year cost',
    ],
    titleLongTail: 'Cost of Car Ownership Per Month & Per KM - Full Breakdown',
    descriptionLongTail: 'Enter your numbers for fuel, insurance, servicing, tires, depreciation and loan interest; get the honest monthly total and per-kilometer rate insurers never mention.',
  },
  {
    slug: 'json-repair', name: 'JSON Repair',
    title: 'JSON Repair - Fix Broken LLM JSON Output Online',
    description: 'Repair malformed JSON from LLMs: truncated objects, trailing commas, single quotes, unquoted keys, markdown fences, and control characters. See what was fixed and why.',
    keywords: ['json repair', 'fix invalid json', 'llm json output fix', 'json parse error repair', 'trailing comma remover'],
    intent: 'informational', category: 'AI Tools', h1: 'JSON Repair',
    shortIntro: 'Rescue malformed LLM JSON — truncated, trailing commas, fences.', published: true,
    longTailKeywords: [
      'fix json from chatgpt output',
      'remove trailing commas json online',
      'repair truncated json response',
      'json unexpected end of input fix',
    ],
    titleLongTail: 'Fix Invalid JSON from AI Models - With Repair Log',
    descriptionLongTail: 'Paste the broken payload; get valid JSON back plus an itemized list of every repair applied. Handles the specific ways LLMs break JSON.',
  },
  {
    slug: 'markdown-fence-extractor', name: 'Code Block Extractor',
    title: 'Extract Code Blocks from Markdown or AI Answers',
    description: 'Pull every fenced code block out of Markdown or LLM responses — filter by language, copy each block, or download them all. Handles nested fences and indented blocks.',
    keywords: ['extract code blocks markdown', 'markdown fence extractor', 'get code from chatgpt answer', 'split markdown code blocks', 'llm code extraction'],
    intent: 'informational', category: 'AI Tools', h1: 'Code Block Extractor',
    shortIntro: 'Pull every ``` code block out of Markdown or AI answers.', published: true,
    longTailKeywords: [
      'extract python code from chatgpt response',
      'markdown code block splitter online',
      'copy all code blocks from markdown',
      'remove markdown keep only code',
    ],
    titleLongTail: 'Get Code Only from AI/Markdown - Filter by Language',
    descriptionLongTail: 'Paste a chat answer or README; every fenced block is listed with its language tag, one-click copy, and an all-blocks download. Prose vanishes.',
  },
  {
    slug: 'prompt-template-filler', name: 'Prompt Template Filler',
    title: 'Prompt Template Filler - Fill {{Variables}} in AI Prompts',
    description: 'Fill {{variable}} placeholders in prompt templates with a JSON object or form inputs. Live preview, missing-variable warnings, escape handling. Runs fully in-browser.',
    keywords: ['prompt template filler', 'mustache template variables', 'fill prompt variables', 'jinja template tester', 'ai prompt variables'],
    intent: 'informational', category: 'AI Tools', h1: 'Prompt Template Filler',
    shortIntro: 'Fill {{variables}} in prompt templates from JSON — live preview.', published: true,
    longTailKeywords: [
      'fill mustache variables online',
      'prompt template variable substitution',
      'test prompt template with values',
      'replace placeholders in prompt',
    ],
    titleLongTail: 'Fill {{Vars}} in LLM Prompts - JSON Input, Live Preview',
    descriptionLongTail: 'Paste a template with {{name}}-style placeholders and a JSON object of values; see the filled result instantly, with unfilled-variable warnings.',
  },
  {
    slug: 'openai-tools-builder', name: 'OpenAI Tools JSON Builder',
    title: 'Function Calling Builder - Generate OpenAI/Anthropic Tools JSON',
    description: 'Build function-calling tool definitions through a form: name, description, typed parameters with enums and required flags. Output clean JSON for the tools API param.',
    keywords: ['openai tools json', 'function calling builder', 'openai api tool definition', 'llm function schema generator', 'tools parameter format'],
    intent: 'informational', category: 'AI Tools', h1: 'Function Calling Tools Builder',
    shortIntro: 'Form-built tool definitions → clean tools JSON for LLM APIs.', published: true,
    longTailKeywords: [
      'openai function calling json example',
      'tools parameter format openai api',
      'llm tool schema generator online',
      'anthropic tool use json format',
    ],
    titleLongTail: 'Generate Tools Array JSON - Typed Params & Required Flags',
    descriptionLongTail: 'Skip hand-writing nested JSON schemas: describe parameters with types, enums, and required flags in a form, and copy the exact tools array the API expects.',
  },
  {
    slug: 'csv-to-finetune-jsonl', name: 'CSV to Fine-tuning JSONL',
    title: 'CSV to JSONL Converter - OpenAI Fine-tuning Format',
    description: 'Convert CSV training data into OpenAI fine-tuning JSONL: chat-messages format with system/user/assistant roles. Column mapping, validation, and instant preview. Runs locally.',
    keywords: ['csv to jsonl', 'openai fine-tuning format converter', 'jsonl generator from csv', 'fine-tune dataset converter', 'chatml training data'],
    intent: 'informational', category: 'AI Tools', h1: 'CSV to Fine-tuning JSONL',
    shortIntro: 'CSV training rows → OpenAI chat-format JSONL, mapped and validated.', published: true,
    longTailKeywords: [
      'convert csv to jsonl for fine-tuning',
      'openai fine tuning dataset format example',
      'chat messages jsonl training data',
      'prepare fine-tune data from spreadsheet',
    ],
    titleLongTail: 'Make Fine-tuning Datasets from CSV - Chat Format JSONL',
    descriptionLongTail: 'Point your spreadsheet columns at system/user/assistant roles and export valid .jsonl for the fine-tuning API — with per-row validation before you burn tokens.',
  },
  {
    slug: 'token-visualizer', name: 'Token Visualizer',
    title: 'Token Visualizer - See How Text Splits into LLM Tokens',
    description: 'Watch text split into approximate LLM tokens with color-coded boundaries and per-token counts. Understand why some words cost more tokens than others.',
    keywords: ['token visualizer', 'see tokens llm', 'text tokenization visual', 'how many tokens per word', 'token boundaries'],
    intent: 'informational', category: 'AI Tools', h1: 'Token Visualizer',
    shortIntro: 'Color-coded token boundaries with counts — see what models see.', published: true,
    longTailKeywords: [
      'how does tokenization split words',
      'visualize gpt tokens online',
      'why does my text cost so many tokens',
      'token boundaries color highlight',
    ],
    titleLongTail: 'How Tokenizers Split Your Text - Colored Chunk View',
    descriptionLongTail: 'Paste text and see it chunked into approximate tokens, each color-coded, with counts per chunk — the fastest way to build intuition for token costs.',
  },
  {
    slug: 'embedding-price-calculator', name: 'Embedding Price Calculator',
    title: 'Embedding API Cost Calculator - Text-embedding Prices Compared',
    description: 'Compare embedding API costs across OpenAI, Cohere, and open-source-hosted models: dimensions, price per million tokens, and your real workload cost.',
    keywords: ['embedding price calculator', 'openai embedding cost', 'text-embedding-3 price', 'embedding api comparison', 'vector embedding cost'],
    intent: 'commercial', category: 'AI Tools', h1: 'Embedding Price Calculator',
    shortIntro: 'Embedding costs across models: dimensions, $/1M tokens, workload totals.', published: true,
    longTailKeywords: [
      'how much does openai embedding api cost',
      'text-embedding-3-small vs large price',
      'embedding cost per million tokens',
      'cheapest embedding api comparison',
    ],
    titleLongTail: 'Embedding Cost per 1M Tokens - Model & Dimension Table',
    descriptionLongTail: 'Enter documents and average length; get cost per run and per month across the major embedding APIs, with dimensions and context limits side by side.',
  },
]
// 图标解析已拆分至 lib/tool-icons.ts(客户端安全的轻量模块),此处 re-export 保持兼容
