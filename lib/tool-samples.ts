...
export const calculatorSamples: Record<string, Record<string, string>> = {
  ...
  'mortgage-calculator': { homePrice: '450000', downPayment: '90000', rate: '6.8', years: '30' },
  ...
  'credit-card-payoff-calculator': { balance: '8000', rate: '22', payment: '300' },
  'credit-card-minimum-payment-calculator': { balance: '5000', rate: '22', minPercent: '2' },
  'roi-calculator': { initial: '10000', final: '15000', years: '3' },
  'apy-calculator': { apr: '4.5', compounding: '12' },
  'markup-calculator': { cost: '60', margin: '40' },
  'commission-calculator': { sale: '400000', rate: '3' },
  'tip-calculator': { bill: '85', tipPct: '18', people: '2' },
  'bill-split-calculator': { bill: '120', people: '4', tipPercent: '18' },
  'discount-calculator': { price: '79.99', discount: '30' },
  'sales-tax-calculator': { amount: '50', rate: '8.25' },
  'percentage-calculator': { x: '25', y: '200', mode: '1' },
  'cash-back-calculator': { spend: '24000', ratePercent: '2' },
  'down-payment-calculator': { homePrice: '400000', downPercent: '20' },
  'dti-calculator': { income: '6000', debt: '1500' },
  'income-tax-estimator': { income: '75000', filing: 'single' },
  'capital-gains-tax-estimator': { purchase: '10000', sale: '16000', holding: 'long', income: '85000' },
  'rent-vs-buy-calculator': { rent: '1800', homePrice: '400000', years: '7' },
  'hourly-to-salary-calculator': { hourly: '28', hours: '40' },
  'salary-converter': { annual: '65000' },
  'retirement-calculator': { current: '120000', contribution: '800', years: '30', rate: '6' },
  'net-worth-calculator': { assets: '450000', liabilities: '180000' },
  'inflation-calculator': { amount: '1000', startYear: '2010', endYear: '2024' },
  'unit-price-calculator': { price: '12.99', quantity: '750', unit: 'ml' },

  // ── 健康 ──
  'bmi-calculator': { weight: '70', height: '175' },
  'bmr-calculator': { weight: '70', height: '175', age: '30', sex: 'male' },
  'calorie-calculator': { weight: '70', height: '175', age: '30', sex: 'male', activity: 'moderate' },
  'body-fat-calculator': { waist: '85', neck: '38', height: '175', hip: '95', sex: 'male' },
  ...
  // ── 数学 / 几何 ──
  'circle-calculator': { radius: '8' },
  'triangle-calculator': { a: '3', b: '4', c: '5' },
  'rectangle-calculator': { width: '12', height: '8' },
  'trapezoid-calculator': { a: '6', b: '10', height: '4' },
  'cube-calculator': { edge: '5' },
  'sphere-calculator': { radius: '7' },
  ...
  'percentile-calculator': { numbers: '40, 55, 60, 70, 80, 90', percentile: '75' },
  'prime-number-checker': { number: '9973' },
  'prime-factorization-calculator': { number: '360' },

  // ── 教育成绩 ──
  'gpa-calculator': { courses: '4' },
  'grade-calculator': { current: '85', finalWeight: '20', target: '90' },
  'final-grade-calculator': { current: '85', target: '90', finalWeight: '25' },
  'age-calculator': { dob: '1995-06-15' },
  'age-difference-calculator': { dob1: '1990-01-01', dob2: '1998-09-20' },
