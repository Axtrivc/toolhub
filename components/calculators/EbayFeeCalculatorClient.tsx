...
export function EbayFeeCalculatorClient() {
  ...
  return (
    <div className="space-y-6">
      ...
      {'error' in parsed ? (
        <div role="status" className="rounded-lg border border-red-200 dark:border-red-800/60 bg-red-50 dark:bg-red-950/30 p-4 text-sm text-red-700 dark:text-red-300">{L('errorWarn', '⚠️ ')}{parsed.error}</div>
      ) : (
        <>
