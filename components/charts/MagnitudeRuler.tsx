 ...
 * 两个圆点随输入实时滑动(CSS left 过渡,只动 paint 属性),刻度自动取
    ...
    <ChartCard title={title}>
      <div className="relative h-24 select-none" aria-hidden="true">
        ...
        <div
          ...
          style={{ left: `${pos(lgFrom)}%`, transition: 'left 300ms cubic-bezier(0.22,1,0.36,1)' }}
        >
        ...
        <div
          ...
          style={{ left: `${pos(lgTo)}%`, transition: 'left 300ms cubic-bezier(0.22,1,0.36,1)' }}
        >
